"""
app/voice/streaming_buffer.py
-----------------------------
Production Streaming Text Buffer.
Deterministic token accumulation with leading-space BPE boundary detection,
...
class StreamingTextBuffer:
    ...
    Correctly recognizes BPE leading-space word boundaries across 15 Indic & global scripts.
    """
